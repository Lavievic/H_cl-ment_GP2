...
void drawCatmull(sf::RenderWindow &win, float now) {
	...
	*/
	...
	shape.setFillColor(sf::Color(0xB3B31B));
...
int main()
{
	...
	if ((std::abs((RectangleShape.getPosition().x + 24) - (sprite2.getPosition().x + 24)) < sprite2.scale) &&
		(std::abs((RectangleShape.getPosition().y + 24) - (sprite2.getPosition().y + 24)) < sprite2.scale))
	{
